...
CREATE TABLE account_info_statistics_company
(
  ...
  CONSTRAINT account_info_statistics_company_global_pkey PRIMARY KEY (account_id)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE account_info_statistics_company
